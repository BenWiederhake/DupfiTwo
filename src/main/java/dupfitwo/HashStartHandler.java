...
public final class HashStartHandler implements ClashHandler {
    ...
    public HashStartHandler(final ClashHandler backing, final int bufSize) {
    ...
    final Collection<Entry<Long, Collection<Path>>> files) {
        ...
        long ret = 0;
        for (final Entry<ByteBuffer, Collection<Entry<Long, Collection<Path>>>> e : table
            .asMap()
            .entrySet()) {
